...
const SAVED_ADDRESSES = [
  { id: "1", label: "Home", address: "Flat 4B, Sunrise Apartments, Koramangala, Bengaluru - 560034", isDefault: true, icon: "home" as const },
  { id: "2", label: "Work", address: "WeWork Galaxy, 43 Residency Road, MG Road, Bengaluru - 560025", isDefault: false, icon: "briefcase" as const },
];
...
export default function AddressesScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        {addresses.map((addr) => (
          <View key={addr.id} style={[styles.card, { backgroundColor: colors.card }, shadows.sm]}>
            <View style={[styles.addrIcon, { backgroundColor: addr.isDefault ? colors.primary + "15" : colors.muted }]}>
              <Feather name={addr.icon} size={20} color={addr.isDefault ? colors.primary : colors.secondary} />
            </View>
        ...
        <Pressable style={[styles.addCard, { borderColor: colors.border }]}>
